    ...
    <aside className="h-screen w-64 bg-white border-r border-gray-200 flex flex-col justify-between shadow-sm flex-shrink-0 z-40">
      ...
      <div>
        ...
        <div className="mt-5 ml-3 mb-10 px-2 flex items-center gap-3">
          ...
          <div>
              <h1 className="text-xl font-bold text-blue-800 tracking-tight">Coraje</h1>
              <h2 className="text-xs font-bold text-slate-500 uppercase tracking-widest">Centro de Servicio</h2>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 shadow-[0_0_10px_0px_rgba(0,0,0,0.2)] shadow-blue-500/100 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold">
